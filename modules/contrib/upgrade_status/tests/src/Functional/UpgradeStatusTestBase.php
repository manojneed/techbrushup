...
abstract class UpgradeStatusTestBase extends BrowserTestBase {
  ...
  protected function runFullScan() {
    $edit = [
      ...
      'scan[data][list][upgrade_status_test_13_compatible]' => TRUE,
      ...
      ($this->getDrupalCoreMajorVersion() < 12 ? 'relax' : 'collaborate') . '[data][list][upgrade_status]' => TRUE,
      ($this->getDrupalCoreMajorVersion() < 12 ? 'relax' : 'collaborate') . '[data][list][upgrade_status_test_contrib_12_compatible]' => TRUE,
    ];
