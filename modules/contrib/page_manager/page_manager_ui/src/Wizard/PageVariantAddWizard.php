...
class PageVariantAddWizard extends EntityFormWizardBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $page = NULL) {
    ...
    // Get the page tempstore so we can modify the unsaved page. The condition
    // that used to wrap this referenced $cached_values before it was assigned,
    // so it always evaluated to TRUE; the assignment is now unconditional to
    // keep the behavior while removing the undefined variable.
